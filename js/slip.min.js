...
(function(WIN, DOC) {
  ...
  WINDOW_HEIGHT = WIN['innerHeight'] <= (document.body.clientHeight || document.documentElement.clientHeight) ?  WIN['innerHeight'] : (document.body.clientHeight || document.documentElement.clientHeight);
  ...
  Slip = (function() {
    ...
    Slip.prototype.onTouchMove = function(event) {
      ...
      //以下两行为控制不出白而加，啦啦
      if(this.page==0&&finger.y>0){
        return false;
      }
      if(this.page==this.pageNum-1&&finger.y<0){
        return false;
      }
      this.orient = orient;
